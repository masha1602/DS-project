...
library(readxl)
library(leaflet)
yelp_flat24 <- read_excel("yelp_flat24 (1).xlsx")
yelp_flat24 = distinct(yelp_flat24, title, .keep_all = TRUE)
Subway <- read_excel("Subway (1).xlsx")
...
jopa322 = read.csv("~/jopa322")
jopa322 = jopa322$cites
yelp_flat24$cord = yelp_flat24$title %in% jopa322
yelp_flat24 = filter(yelp_flat24, cord == TRUE)
yelp_flat24 = select(yelp_flat24, title, lat, lng)
full = rbind(subcord, yelp_flat24)
